...
type GetProjectsRequest struct {
	...
	// 为空表示根据其他条件搜索
	ProjectsID           []int64  `protobuf:"varint,2,rep,packed,name=ProjectsID,proto3" json:"ProjectsID,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *GetProjectsRequest) GetProjectsID() []int64 {
	if m != nil {
		return m.ProjectsID
	}
	return nil
...
var fileDescriptor_6a534611bb3d10c3 = []byte{
	...
	,
}
